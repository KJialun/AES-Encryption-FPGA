...
architecture Behavioral of Three_step is
...
signal order                 : STD_LOGIC_VECTOR(2   downto 0);
 type counttype is (idle,s1,s2,s3);
 signal currentstate , nextstate : counttype;
        begin
            ...
            Add  : add_round_key port map(clk => clk, rst => rst, en=>order(2), ark_byte_in => sh_byte_out, ark_byte_out => byte_out, key => key);
